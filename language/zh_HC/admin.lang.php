...
// +-----------------------------------------------------------------------+
$lang['%d photos uploaded'] = '%d 張畫作已被上傳';
$lang['%d photos were deleted'] = '%d 張畫作已被刪除';
...
$lang['%d album including'] = '包含 %d 畫廊';
$lang['%d album moved'] = '%d 畫廊已移走';
$lang['%d albums including'] = '包含 %d 畫廊';
$lang['%d albums moved'] = '%d 畫廊已移走';
...
$lang['private'] = '私人';
$lang['public'] = '公開';
$lang['randomly represented'] = '隨機畫廊縮圖';
$lang['sub-albums'] = '畫廊子　';
...
$lang['visitors need to login and have the appropriate permissions to see this album'] = '訪客需要登入及指定權限才看到畫廊';
...
$lang['%s photos can not be regenerated'] = '%s 張畫作不能重新製作';
$lang['%s photos have been regenerated'] = '%s 張畫作已成功製作';
...
$lang[', click on'] = ', 按在';
$lang['... or '] = '...或';
$lang['A locked gallery is only visible to administrators'] = '已封鎖的畫廊祗會被管理員看到';
$lang['albums added in the database'] = '畫廊已在數量庫增加';
$lang['albums deleted in the database'] = '畫廊已在數量庫刪除';
$lang['all'] = '全部';
$lang['an error happened'] = '一個錯誤出現';
$lang['and'] = '及';
$lang['any visitor can see this album'] = '所有訪客都可看到這個畫廊';
...
$lang['confirm'] = '確定';
$lang['Anomaly'] = '異常';
$lang['Album name'] = '畫廊名稱';
$lang['Album updated successfully'] = '畫廊更新成功';
$lang['Albums automatically sorted'] = '畫廊自動排列';
$lang['All %d photos are selected'] = '所有 %d 張畫作已選';
...
$lang['Activate icon "new" next to albums and pictures'] = '啟動圖標"new"在畫廊及畫作旁';
...
$lang['IP'] = 'IP';
$lang['If no HD is available and if the current websize is bigger than resize dimensions, Piwigo will move it as HD and create a downsized websize photo from it.'] = '假如畫作影像檔案非高畫質，但在網頁上畫作尺寸大於調整後尺寸，Piwigo仍會將畫作影像標為高畫質，並另存一張縮圖';
...
$lang['Image Quality'] = '畫作質量';
$lang['Image id'] = '畫作ID';
$lang['Images manual order was saved'] = '畫作手動排序已保存';
$lang['Gallery unlocked'] = '畫廊已解鎖';
$lang['General'] = '普通';
$lang['General statistics'] = '普通統計';
$lang['Generate multiple size images'] = '產生多種大小的畫作影像檔案';
...
$lang['Features include gallery browsing, album creation and photo upload.'] = '功能包括：畫廊瀏覽、建立畫廊和畫作上傳';
$lang['File'] = '檔案';
$lang['File upload stopped by extension'] = '擴展使文件上傳停止';
$lang['File/directory read error'] = '檔案/目錄的讀取錯誤';
$lang['Find a new representant by random'] = '搜尋一個新的隨機畫廊縮略圖';
...
$lang['For photo sizes with crop, such as "Square", Piwigo will do its best to include the center of interest.'] = '如選擇畫作影像剪裁（如「正方形」），Piwigo會盡可能保留畫作的焦點';
...
$lang['Discover album:'] = '探索畫廊:';
$lang['Display options'] = '顯示選項';
$lang['Dissociate from album'] = '從畫廊裡分離';
...
$lang['Edit album'] = '修改畫廊';
$lang['Edit album permissions'] = '管理畫廊權限';
$lang['Edit photo'] = '編輯畫作';
$lang['Default display'] = '預設顯示資訊';
$lang['Default photos order'] = '預設的畫作順序';
$lang['Default user cannot be deleted'] = '不能刪除預設用戶';
$lang['Default user does not exist'] = '預設用戶不存在';
$lang['Delete Representant'] = '刪除畫廊縮略圖';
$lang['Delete multiple size images'] = '刪除多種大小的畫作影像';
$lang['Delete orphan tags'] = '刪除沒被關聯的標籤';
$lang['Delete selected photos'] = '刪除畫作';
...
$lang['Associate to album'] = '關聯到畫廊';
$lang['Associated'] = '已關聯';
$lang['Authorize users to add comments on selected albums'] = '讓用戶可在所選畫廊裡發表評論';
$lang['Authorized'] = '已授權';
...
$lang['By %s'] = '按 %s';
$lang['By default, Piwigo will create a new websize from the HD (high definition) version of your photo.'] = '在預設狀況下，Piwigo 將從原畫作的高清晰度版本，建立另一個適用於網頁的尺寸版本。';
$lang['By default, the center of interest is placed in the middle of the photo.'] = '在預設情況下，焦點是擺在畫作的中間';
$lang['By rank'] = '按等級';
$lang['Caddie'] = '購物籃';
$lang['Caddie management'] = '購物籃管理';
$lang['Album list management'] = '畫廊清單管理';
$lang['Album manual order was saved'] = '畫廊手動排序已保存';
$lang['Album photos associated to the following albums: %s'] = '畫作已關聯到畫廊:%s';
$lang['Albums authorized thanks to group associations'] = '畫廊群組織授權感謝協會';
...
$lang['Aperture is a powerful tool to refine images and manage massive libraries on Mac.'] = 'Aperture是Mac的一項強大工具，可微調讓圖像更精緻，並管理超大畫作庫.';
$lang['Aperture is designed for professional photographers with iPhoto simplicity.'] = 'Aperture是為專業攝影師設計的軟體，但使用起來又與iPhoto一樣簡單.';
$lang['Applications'] = '程式';
$lang['Apply action'] = '執行';
$lang['Apply selected corrections'] = '套用所選的修正';
$lang['Apply to sub-albums'] = '套用到子畫廊';
...
$lang['<em>Piwigo for iOS</em> application empowers you to connect to your Piwigo gallery from your iPhone, iPad or iPod Touch, create some albums and upload several photos at once.'] = '<em>iOS 版的Piwigo</em>允許您從iPhone, iPad 或 iPod Touch 連接到您的Piwigo畫廊，建立多個畫廊並一次上傳多張畫作。';
$lang['Add a criteria'] = '增加准則';
$lang['Add a filter'] = '增加篩選';
$lang['Add a tag'] = '增加標籤';
$lang['Add a virtual album'] = '增加虛擬畫廊';
$lang['Add another set of photos'] = '增加另一組畫作';
...
$lang['Album "%s" has been added'] = '已增加畫廊 "%s" ';
$lang['Album "%s" now contains %d photos'] = '畫廊"%s"現已包含了 %d 張畫作';
$lang['pending validation'] = '待審定';
$lang['photos added in the database'] = '增加畫作到資料庫';
$lang['photos candidates for metadata synchronization'] = '對應同步元數據的候選畫作';
$lang['photos deleted from the database'] = '畫作已從資料庫中刪除';
$lang['photos informations synchronized with files metadata'] = '畫作信息已和檔案metadata同步';
$lang['photos per page'] = '每頁畫作';
$lang['photos updated in the database'] = '更新資料庫中的畫作';
$lang['pixels'] = '像素';
$lang['reduce to single existing albums'] = '減少現有的單獨畫廊';
...
$lang['singly represented'] = '固定畫廊縮略圖';
$lang['status'] = '狀態';
$lang['synchronize files metadata with database photos informations'] = '根據文件metadata同步資料庫中的畫作信息';
$lang['jump to photo'] = '跳到圖';
$lang['leave'] = '離開';
$lang['manage album photos'] = '管理畫廊裡的畫作';
$lang['manage sub-albums'] = '管理子畫廊';
...
$lang['nothing'] = '沒有寫入權限';
$lang['on'] = '在';
$lang['on the %d selected photos'] = '在 %d 張已選畫作上';
$lang['on the %d selected users'] = '%d 的選定用戶';
...
$lang['display maximum informations (added albums and photos, deleted albums and photos)'] = '顯示最大量的信息(增加畫廊和畫作,刪除的畫廊和畫作)';
$lang['dissociate from group'] = '取消群組關聯';
$lang['errors during synchronization'] = '同步期間發生錯誤';
$lang['even already synchronized photos'] = '包括已經同步的畫作';
$lang['existing album'] = '現有的畫廊';
...
$lang['guest'] = '訪客';
$lang['height must be a number superior to'] = '畫作高度必須超過(整數)';
$lang['hide details'] = '隱藏細節';
$lang['high'] = '高';
$lang['iPhoto is the default photo manager on MacOSX. The Piwigo export plugin let you create new albums and export your photos directly from iPhoto to your Piwigo photo gallery.'] = 'iPhoto是MacOSX預設的畫作管理軟體。此Piwigo匯出插件，可讓你直接從iPhoto匯出畫作至Piwigo圖庫，並建立新畫廊';
$lang['include child albums'] = '包含子畫廊';
$lang['include photos with lower privacy level'] = '包含隱私級別較低的畫作';
$lang['jump to album'] = '跳到畫廊';
$lang['You can update to Piwigo %s directly, without upgrading to Piwigo %s (recommended).'] = '您可直接升級到Piwigo的%s，而不需升級到Piwigo的%s（建議版本）';
$lang['add new photos to caddie'] = '把所有新畫作放到購物籃';
$lang['added'] = '已加入';
$lang['administrators'] = '管理員';
$lang['associate to group'] = '關聯到群組';
$lang['create a new album'] = '建立一個新畫廊';
...
$lang['delete'] = '刪除';
$lang['delete album'] = '刪除畫廊';
$lang['delete photo'] = '刪除畫廊';
$lang['delete this site and all its attached elements'] = '刪除此站點和與其相關聯的所有信息';
$lang['deleted'] = '已刪除';
$lang['digiKam is an advanced digital photo management free software for Linux, Windows, and MacOSX.'] = 'digiKam是一套先進的數位畫作管理軟體，它是自由軟體，適用於LINUX，WINDOWS和MacOSX。';
$lang['digiKam is designed for photographers who want to view, manage, edit, enhance, organize, tag, and share photographs.'] = 'digiKam是專為攝影師瀏覽、管理、編輯、加工、整理、標記及分享畫作等用途而設計。';
...
$lang['You can\'t define a default photo order because you have a custom setting in your local configuration.'] = '無法使用預設畫作順序，因你在本機配置另有自訂設定。';
$lang['You cannot delete your account'] = '你不能刪除自己本身帳號';
$lang['You cannot move an album in its own sub album'] = '您不能將一個畫廊移動到其子畫廊裡';
...
$lang['Who can see these photos?'] = '哪些人可以看到這些畫作?';
$lang['Who can see this photo?'] = '有哪些人能看這些畫作?';
$lang['Width'] = '寬度';
$lang['With blank value, gallery title will be used'] = '圖庫標題允許為空';
$lang['With no album'] = '沒有畫廊';
$lang['With no tag'] = '沒有標籤';
$lang['With no virtual album'] = '沒有虛擬畫廊';
...
$lang['Virtual album'] = '虛擬畫廊';
$lang['Virtual album added'] = '虛擬畫廊已添加';
$lang['Virtual album deleted'] = '虛擬畫廊已刪除';
$lang['Virtual album name'] = '虛擬畫廊名稱';
$lang['Virtual albums to move'] = '移動虛擬畫廊';
...
$lang['Update photos information'] = '更新畫作信息';
$lang['Update to Piwigo %s'] = '更新到Piwigo %s';
$lang['Update user'] = '更新用戶';
$lang['Updates'] = '更新';
$lang['Upload'] = '上傳';
$lang['Upload Photos'] = '上傳畫作';
$lang['Uploaded Photos'] = '畫作已上傳';
$lang['Use the default photo sort order'] = '使用預設的的畫作排序順序';
...
$lang['Update albums informations'] = '上傳畫廊信息';
$lang['There is no other theme available.'] = '沒有其他可用的主題。';
$lang['This album contains %d photos, added between %s and %s.'] = '這本畫廊包含 %d 張畫作，在 %s 和 %s 之間增加。';
$lang['This album contains %d photos, added on %s.'] = '這本畫廊包含 %d 張畫作，在 %s 上增加。';
$lang['This album contains no photo.'] = '這本畫廊沒有畫作';
$lang['This group will be set to default'] = '這本畫廊沒有畫作';
...
$lang['Title'] = '標題';
$lang['To export your photos from digiKam to Piwigo, simply install digiKam and the Kipi-plugins.'] = '從digiKam要匯出畫作到Piwigo，只需安裝digiKam和Kipi-plugins插件。';
$lang['To send ?'] = '發送?';
...
$lang['The picture dimensions will be reduced to %dx%d pixels.'] = '畫作的尺寸將減少到 %dx%d 像素。';
...
$lang['The Piwigo export plugin allows you to create albums and export photos.'] = 'Piwigo的匯出插件，允許你建立畫廊和匯出畫作';
$lang['The Piwigo publish Plug-in allows you to export and synchronize photos from Lightroom directly to your Piwigo photo gallery.'] = 'Piwigo的發布插件允許你 從Lightroom匯出畫作，使你的Lightroom畫作與您的Piwigo畫廊同步。';
$lang['The anomaly will be ignored until next application version'] = '此異常將被忽略，待下次版本中解決';
$lang['The center of interest is the most meaningful zone in the photo.'] = '焦點是畫作中最有意思的部份';
...
$lang['The name of an album must not be empty'] = '畫廊名稱不能為空白';
...
$lang['Start pLoader and add your photos.'] = '開始使用pLoader的並新增你的畫作。';
$lang['Statistics'] = '統計';
$lang['Status'] = '狀態';
$lang['Status of user "%s" updated'] = '用戶 "%s" 狀態已更新';
$lang['Storage album'] = '存儲畫廊';
$lang['Subscribe'] = '訂閱';
...
$lang['Subscribed'] = '已訂閱';
$lang['Subscribers could be listed (available) only if there is new elements to notify.'] = '當有新畫作時,才能使用用戶郵件通知功能.';
...
$lang['Settings'] = '設定';
$lang['Sharpen'] = '銳化';
$lang['Shotwell is an open source digital photo organizer that runs on Linux. It is the default photo manager in Ubuntu and Fedora.'] = 'Shotwell是一套Linux作業系統下的數位畫作管理工具，它是自由軟體，也是 Ubuntu 和 Fedora 中 預設的畫作管理軟體。';
...
$lang['Select an album'] = '選擇一個畫廊';
$lang['Select at least one album'] = '選擇最後一個畫廊';
$lang['Select at least one comment'] = '至少選擇一個評論';
$lang['Select at least one photo'] = '至少選中一張畫作';
...
$lang['Representant'] = '畫廊縮略圖';
$lang['Representation of albums'] = '畫廊縮略圖';
$lang['Representative'] = '畫廊縮略圖';
...
$lang['Search for new images in the directories'] = '在目錄中搜尋新畫作';
$lang['Searching...'] = '搜尋中...';
$lang['Section'] = '區域';
$lang['See you soon,'] = '很快再見，';
$lang['Rate date'] = '投票日期';
...
$lang['Ratio'] = '比例';
$lang['ReGalAndroid (RemoteGallery client for Android) is an open source (GPL v3) Piwigo client for the Android platform.'] = 'ReGalAndroid（Android行動畫廊）是一個開放原始碼軟體（GPL V3），是Android平台上的Piwigo';
$lang['Read Piwigo Documentation'] = '閱讀 Piwigo 檔案';
$lang['Refresh'] = '刷新';
$lang['Refresh photo set'] = '刷新畫作集';
...
$lang['Piwigo publish plugin for Shotwell'] = 'Piwigo 的 Shotwell 畫作發布插件 ';
$lang['Piwigo publish plugin for digiKam'] = 'Piwigo 的 ddgiKam 畫作發布插件';
...
$lang['Permissions'] = '權限';
$lang['Photo %s of %s'] = '畫作 %s 中的畫作 %s';
$lang['Photo Page'] = '畫作頁';
$lang['Photo Properties'] = '畫作屬性';
$lang['Photo informations updated'] = '畫作更新信息';
$lang['Photo name'] = '畫作名稱';
$lang['Photo sizes with crop'] = '畫作影像剪裁';
$lang['Photo unreachable or no support'] = '不支持畫作格式或無法顯示';
$lang['Photos'] = '畫作';
$lang['Photos generation in progress...'] = '畫作製作中...';
$lang['Piwigo Administration'] = 'Piwigo管理';
$lang['Piwigo Announcements Newsletter'] = 'Piwigo最新消息公告';
$lang['Piwigo Publish plugin for Lightroom'] = 'Piwigo 的 Lightroom 畫作發布插件';
$lang['Orphan tags deleted'] = '無關聯標籤已被刪除';
$lang['Other plugins'] = '其他可用的插件';
$lang['Other private albums'] = '其他私人畫廊';
$lang['Overall'] = '概覽';
...
$lang['Permalink'] = '固定連結';
$lang['Permalink %s has been previously used by album %s. Delete from the permalink history first'] = '固定連結 %s 已被 %s 畫廊使用了。請先從固定鏈接歷史記錄刪除。';
$lang['Permalink %s is already used by album %s'] = '固定連結 %s 已被 %s 畫廊使用了';
...
$lang['Only private albums are listed'] = '只列出私人畫廊';
$lang['Opacity'] = '不透明度';
...
$lang['No group is permitted to see this private album'] = '沒有群組別有權限觀看此私人畫廊';
...
$lang['No photo can be deleted'] = '沒有畫作可以刪除';
$lang['No photo in the current set.'] = '當前集合沒有畫作.';
$lang['No photo in this album'] = '沒有畫作在此畫廊裡';
$lang['No photo selected, %d photos in current set'] = '沒有選擇畫作, 當前的集合有 %d 張畫作';
$lang['No photo selected, no action possible.'] = '沒有選擇畫作，不會有動作執行';
$lang['No results'] = '沒有結果';
$lang['No user selected of %d users'] = '%d 個用戶沒有用戶選擇';
...
$lang['Month'] = '月';
$lang['Move'] = '移動';
$lang['Move albums'] = '移動畫廊';
$lang['Move to album'] = '移動到畫廊';
$lang['Multiple Size'] = '多種大小';
$lang['Name'] = '名字';
$lang['Name of the duplicate'] = '名稱重複';
$lang['New Version'] = '新版本';
$lang['New name'] = '新名';
$lang['New parent album'] = '新的父畫廊';
$lang['New photos added'] = '已加入新畫作';
$lang['New photos were added'] = '已加入新畫作';
$lang['New tag'] = '新標籤';
$lang['No destination tag selected'] = '未選擇目標標籤';
$lang['Manage authorizations for selected albums'] = '管理所選畫廊的授權';
$lang['Manage permissions for group "%s"'] = '對群組 "%s" 進行權限管理';
$lang['Manage permissions for user "%s"'] = '對用戶 "%s" 進行權限管理';
$lang['Manage photo ranks'] = '管理畫作排序';
$lang['Manage photos'] = '管理畫作';
$lang['Manage tags'] = '管理標籤';
$lang['Manage the members'] = '管理會員';
$lang['Manage this set of %d photos'] = '管理此設置的 %d 張畫作 ';
$lang['Manual order'] = '手工排序';
...
$lang['Level 4'] = '家庭';
$lang['Level 8'] = '管理者';
$lang['Link all album photos to a new album'] = '鏈接所有畫廊的畫作到新的畫廊';
$lang['Link all album photos to some existing albums'] = '連結所有畫廊的畫作到現有的畫廊';
$lang['Linked albums'] = '已鏈接畫廊';
$lang['List'] = '清單';
...
$lang['Include display of recent photos grouped by dates'] = '包括顯示最近按日期分群組的畫作';
...
$lang['No and unlock sub-albums'] = '否及解開子畫廊';
...
$lang['Delete %d orphan photos'] = '刪除%d個孤兒畫作';
...
沒有選擇收件人';
$lang['No user is permitted to see this private album'] = '沒有用戶被允許看到這個私人畫廊';
$lang['Orphans'] = '孤兒';
$lang['Recipients'] = '收件人';
$lang['Y Repeat'] = 'Y 重複';
$lang['Confirm deletion'] = '確定刪除';
$lang['First photo added'] = '已加入第一張畫作';
