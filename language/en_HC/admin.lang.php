...
$lang['%d album including'] = "%d gallery including";
$lang['%d album moved'] = "%d gallery moved";
$lang['%d albums including'] = "%d galleries including";
$lang['%d albums moved'] = "%d galleries moved";
...
$lang['%d of %d photos selected'] = '%d of %d paintings selected';
$lang['%d parameter was updated.'] = "%d parameter updated.";
$lang['%d parameters were updated.'] = "%d parameters updated.";
$lang['%d photo was deleted'] = "%d painting deleted";
$lang['%d photos uploaded'] = '%d paintings uploaded';
$lang['%d photos were deleted'] = "%d paintings deleted";
...
$lang['%s photos can not be regenerated'] = '%s paintings can not be regenerated';
$lang['%s photos have been regenerated'] = '%s paintings have been regenerated';
...
$lang['Activate icon "new" next to albums and pictures'] = 'Activate icon "new" next to galleries and pictures';
...
$lang['Album "%s" has been added'] = 'Gallery "%s" has been added';
$lang['Album "%s" now contains %d photos'] = 'Gallery "%s" now contains %d paintings';
$lang['Album list management'] = "Gallery list management";
$lang['Album manual order was saved'] = "Gallery manual order was saved";
$lang['Album name'] = 'Gallery name';
$lang['Album photos associated to the following albums: %s'] = "Gallery paintings associated to the following galleries: %s";
$lang['Album updated successfully'] = "Gallery updated successfully";
$lang['albums added in the database'] = "galleries added in the database";
$lang['Albums authorized thanks to group associations'] = "Galleries authorized thanks to group associations";
$lang['Albums automatically sorted'] = 'Galleries automatically sorted';
$lang['albums deleted in the database'] = "galleries deleted in the database";
$lang['All %d photos are selected'] = 'All %d paintings are selected';
...
$lang['Apply to sub-albums'] = "Apply to sub-galleries";
...
$lang['Associate to album'] = "Associate to gallery";
$lang['associate to group'] = "associate to group";
$lang['Associated'] = "Associated";
$lang['Authorize users to add comments on selected albums'] = "Authorize users to add comments on selected galleries";
...
$lang['By %s'] = 'By %s';
$lang['By default, Piwigo will create a new websize from the HD (high definition) version of your photo.'] = 'By default, Piwigo will create a new websize from the HD (high definition) version of your painting file.';
$lang['By default, the center of interest is placed in the middle of the photo.'] = 'By default, the center of interest is placed in the middle of the painting.';
...
$lang['create a new album'] = 'create a new gallery';
...
$lang['Default photos order'] = "Default paintings order";
...
$lang['delete album'] = "delete gallery";
$lang['Delete multiple size images']='Delete multiple size images';
$lang['Delete orphan tags'] = 'Delete orphan tags';
$lang['delete photo'] = 'delete painting';
$lang['Delete Representant'] = "Delete gallery thumbnail";
$lang['Delete selected photos'] = "Delete selected paintings";
...
$lang['digiKam is an advanced digital photo management free software for Linux, Windows, and MacOSX.'] = 'digiKam is an advanced digital painting management free software for Linux, Windows, and macOS.';
...
$lang['Discover album:'] = "Discover gallery:";
$lang['display maximum informations (added albums and photos, deleted albums and photos)'] = 'display maximal information (added galleries and paintings, deleted galleries and paintings)';
$lang['Display options'] = "Display options";
$lang['display'] = 'display';
$lang['Dissociate from album'] = "Dissociate from gallery";
...
$lang['Drop into album'] = 'Select an gallery';
...
$lang['Edit album permissions'] = "Edit gallery permissions";
$lang['Edit album'] = "Edit gallery";
$lang['Edit photo'] = 'Edit painting';
...
$lang['even already synchronized photos'] = "even already synchronized paintings";
...
$lang['Features include gallery browsing, album creation and photo upload.'] = 'Features include gallery browsing, gallery creation and painting upload.';
...
$lang['Find a new representant by random'] = "Find a new random gallery thumbnail";
$lang['first photo added on %s'] = "first painting added on %s";
...
$lang['For photo sizes with crop, such as "Square", Piwigo will do its best to include the center of interest.'] = 'For painting sizes with crop, such as "Square", Piwigo will do its best to include the center of interest.';
...
$lang['include child albums'] = 'include child galleries';
$lang['Include display of recent photos grouped by dates'] = "Include display of recent paintings grouped by dates";
...
$lang['include photos with lower privacy level'] = 'include paintings with lower privacy level';
...
$lang['Invert'] = 'Invert';
$lang['IP'] = "IP";
$lang['iPhoto is the default photo manager on MacOSX. The Piwigo export plugin let you create new albums and export your photos directly from iPhoto to your Piwigo photo gallery.'] = 'iPhoto is the default painting manager on macOS. The Piwigo export plugin lets you create new galleries and export your paintings directly from iPhoto to your Piwigo painting gallery.';
$lang['jump to album'] = "jump to gallery";
$lang['jump to photo'] = "jump to painting";
...
$lang['Level 4'] = "Family";
$lang['Level 8'] = "Admins";
$lang['Link all album photos to a new album'] = "Link all gallery paintings to a new gallery";
$lang['Link all album photos to some existing albums'] = "Link all gallery paintings to some existing galleries";
$lang['Linked albums'] = "Linked galleries";
$lang['List'] = 'List';
$lang['Local'] = "Local";
$lang['Lock albums'] = "Lock galleries";
...
$lang['manage album photos'] = "manage gallery paintings";
$lang['Manage authorizations for selected albums'] = "Manage authorizations for selected galleries";
...
$lang['Manage photo ranks'] = 'Paintings sort order';
$lang['Manage photos'] = 'Manage paintings';
$lang['manage sub-albums'] = "manage sub-galleries";
$lang['Manage tags'] = "Manage tags";
$lang['Manage the members'] = 'Manage the members';
$lang['Manage this set of %d photos'] = 'Manage this set of %d paintings';
$lang['Manage'] = "Manage";
...
$lang['Month'] = "Month";
$lang['Move albums'] = "Move galleries";
$lang['Move to album'] = 'Move to gallery';
$lang['Move'] = "Move";
...
$lang['New photos added'] = "New paintings added";
$lang['New photos were added'] = "New paintings have been added";
$lang['New tag'] = "New tag";
$lang['New Version'] = 'New Version';
$lang['new'] = "new";
$lang['No and unlock sub-albums'] = 'No and unlock sub-galleries';
...
$lang['No photo can be deleted'] = "No painting can be deleted";
$lang['No photo in the current set.'] = 'No painting in the current set.';
$lang['No photo in this album'] = "No painting in this album";
$lang['No photo selected, %d photos in current set'] = 'No painting selected, %d paintings in current set';
$lang['No photo selected, no action possible.'] = 'No painting selected, no action possible.';
...
$lang['Number of albums per page'] = 'Number of galleries per page';
...
$lang['on the %d selected photos'] = 'on the %d selected paintings';
...
$lang['Only private albums are listed'] = "Only private galleries are listed";
...
$lang['Other private albums'] = "Other private galleries";
$lang['other'] = "other";
...
$lang['Permalink %s has been previously used by album %s. Delete from the permalink history first'] = "Permalink %s has previously been used by gallery %s. Delete it from the permalinks history first";
$lang['Permalink %s is already used by album %s'] = "Permalink %s is already used by gallery %s";
...
$lang['Photo %s of %s'] = 'Painting %s of %s';
$lang['Photo informations updated'] = 'Painting information updated';
$lang['Photo name'] = 'Painting name';
$lang['Photo Page'] = 'Painting page';
$lang['Photo Properties'] = 'Painting properties';
$lang['Photo sizes with crop'] = 'Painting sizes with crop';
$lang['Photo unreachable or no support'] = "Painting unreachable or unsupported format";
$lang['photos added in the database'] = "paintings added in the database";
$lang['photos candidates for metadata synchronization'] = "paintings candidates for metadata synchronization";
$lang['photos deleted from the database'] = "paintings deleted from the database";
$lang['Photos generation in progress...'] = 'Paintings generation in progress...';
$lang['photos informations synchronized with files metadata'] = 'paintings\' information synchronized with files metadata';
$lang['photos per page'] = "paintings per page";
$lang['photos updated in the database'] = "paintings updated in the database";
$lang['Photos'] = "Paintings";
...
$lang['Random photo'] = "Random painting";
$lang['randomly represented'] = "random gallery thumbnail";
$lang['ranks'] = "ranks";
...
$lang['reduce to single existing albums'] = "reduce to single existing galleries";
$lang['Refresh photo set'] = 'Refresh painting set';
...
$lang['Representant'] = "Gallery Thumbnail";
$lang['Representation of albums'] = "Gallery thumbnail";
$lang['Representative'] = 'Gallery thumbnail';
...
$lang['Select at least one photo'] = "Select at least one painting";
...
$lang['Shotwell is an open source digital photo organizer that runs on Linux. It is the default photo manager in Ubuntu and Fedora.'] = 'Shotwell is an open source digital painting organizer that runs on Linux. It is the default painting manager in Ubuntu and Fedora.';
...
$lang['singly represented'] = 'fixed gallery thumbnail';
...
$lang['Start pLoader and add your photos.'] = 'Start pLoader and add your paintings.';
...
$lang['synchronize files metadata with database photos informations'] = "synchronize database paintings with files metadata";
...
$lang['The center of interest is the most meaningful zone in the photo.'] = 'The center of interest is the most meaningful area of the painting.';
...
$lang['The name of an album must not be empty'] = "The name of an gallery must not be empty";
...
$lang['The Piwigo export plugin allows you to create albums and export photos.'] = 'The Piwigo export plugin allows you to create galleries and export paintings.';
$lang['The Piwigo publish Plug-in allows you to export and synchronize photos from Lightroom directly to your Piwigo photo gallery.'] = 'The Piwigo publish Plug-in allows you to export and synchronize paintings from Lightroom directly to your Piwigo painting gallery.';
...
$lang['This album contains %d photos, added between %s and %s.'] = 'This gallery contains %d paintings, added between %s and %s.';
$lang['This album contains %d photos, added on %s.'] = 'This gallery contains %d paintings, added on %s.';
$lang['This album contains no photo.'] = 'This gallery contains no painting.';
...
$lang['Time'] = "Time";
$lang['Title'] = "Title";
$lang['To export your photos from digiKam to Piwigo, simply install digiKam and the Kipi-plugins.'] = 'To export your paintings from digiKam to Piwigo, simply install digiKam and the Kipi-plugins.';
...
$lang['Update albums informations'] = 'Update galleries\' information';
...
$lang['Update photos information'] = 'Update paintings\' information';
$lang['update the database from files'] = "update the database with files";
$lang['Update to Piwigo %s'] = 'Update to Piwigo %s';
$lang['Updates'] = 'Updates';
$lang['Upload Photos'] = 'Upload Paintings';
$lang['Upload'] = "Upload";
$lang['Uploaded Photos'] = 'Uploaded Paintings';
$lang['Use the default photo sort order'] = "Use the default painting sort order";
...
$lang['Virtual album added'] = "Virtual gallery added";
$lang['Virtual album deleted'] = "Virtual gallery deleted";
$lang['Virtual album name'] = "Virtual gallery name";
$lang['Virtual album'] = "Virtual gallery";
$lang['Virtual albums to move'] = "Virtual galleries to move";
...
$lang['Who can see these photos?'] = 'Who can see these paintings?';
$lang['Who can see this photo?'] = 'Who can see this painting?';
...
$lang['You cannot move an album in its own sub album'] = "You cannot move an gallery in its own sub gallery";
$lang['You can\'t define a default photo order because you have a custom setting in your local configuration.'] = 'You can\'t define a default painting order because you have a custom setting in your local configuration.';
...
$lang['Zoom'] = 'Zoom';
$lang['[%s] Visit album %s'] = "[%s] Visit gallery %s";
...
$lang['Delete %d orphan photos'] = 'Delete %d orphan paintings';
...
$lang['Delete album "%s".'] = 'Delete gallery "%s".';
$lang['Delete album "%s" and its %d sub-albums.'] = 'Delete gallery "%s" and its %d sub-galleries.';
$lang['delete album and all %d photos, even the %d associated to other albums'] = 'delete gallery and all %d paintings, even the %d associated to other galleries';
$lang['delete album and the %d orphan photos'] = 'delete gallery and the %d orphan paintings';
$lang['delete only album, not photos'] = 'delete only gallery, not paintings';
...
$lang['First photo added'] = 'First painting added';
$lang['No filter on album. Select one or type to search'] = 'No filter on album. Select one or type to search';
$lang['Piwigo Remote Sync is able to upload a whole folder hierarchy. If you run it again, only new photos will be uploaded.'] = 'Piwigo Remote Sync is able to upload a whole folder hierarchy. If you run it again, only new paintings will be uploaded.';
$lang['Share / Send your photos directly from your Mac Os X (10.10 and following) to Piwigo'] = 'Share / Send your paintings directly from your macOS (10.10 and later) to Piwigo';
$lang['(determined from photos)'] = '(determined from paintings)';
