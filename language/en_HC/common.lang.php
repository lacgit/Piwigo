...
$lang['%d album updated'] = "%d gallery updated";
$lang['%d albums updated'] = "%d galleries updated";
...
$lang['%d new photo'] = "%d new painting";
$lang['%d new photos'] = "%d new paintings";
$lang['%d new user'] = "%d new user";
$lang['%d new users'] = "%d new users";
$lang['%d photo is also linked to current tags'] = "%d painting is also linked to current tags";
$lang['%d photo'] = "%d photo";
$lang['%d photos are also linked to current tags'] = "%d paintings are also linked to current tags";
$lang['%d photos'] = "%d paintings";
$lang['%d rate'] = '%d rate';
...
$lang['add this photo to your favorites'] = "add this painting to your favorites";
$lang['Admin: %s'] = "Admin: %s";
$lang['Administration'] = "Administration";
$lang['Album results for'] = "Gallery results for";
$lang['Album'] = "Gallery";
$lang['Album: %s'] = "Gallery: %s";
$lang['Albums'] = "Galleries";
...
$lang['Click on the photo to see it in high definition'] = "Click on the painting to see it in high definition";
...
$lang['Complete RSS feed (photos, comments)'] = "Complete RSS feed (paintings, comments)";
$lang['Confirm Password'] = "Confirm Password";
$lang['Connected user: %s'] = "Connected user: %s";
$lang['Connection settings'] = "Connection settings";
$lang['Contact webmaster'] = "Contact HonChai.com";
...
$lang['delete all photos from your favorites'] = "delete all paintings from your favorites";
$lang['delete this photo from your favorites'] = "delete this painting from your favorites";
$lang['Delete'] = "Delete";
...
$lang['display a set of random photos'] = "display a set of random paintings";
$lang['display all photos in all sub-albums'] = "display all paintings in all sub-galleries";
$lang['display available tags'] = "display available tags";
$lang['display best rated photos'] = "display best rated paintings";
$lang['display each day with photos, month per month'] = "display each day with paintings, month per month";
$lang['display last user comments'] = "display last user comments";
$lang['display most recent photos'] = "display most recent paintings";
$lang['display most visited photos'] = "display most visited paintings";
$lang['display only recently posted photos'] = "display only recently posted paintings";
$lang['display photos linked to this tag'] = "display paintings linked to this tag";
$lang['display recently updated albums'] = "display recently updated galleries";
$lang['display this album'] = "display this gallery";
$lang['display your favorites photos'] = "display your favorites paintings";
...
$lang['Expand all albums'] = "Expand all galleries";
...
$lang['Go back to the album'] = "Go back to the gallery";
$lang['Go through the gallery as a visitor'] = "Navigate the gallery as a visitor";
$lang['group by letters'] = "group by letters";
$lang['guest'] = "guest";
$lang['Hello %s, your Piwigo photo gallery is empty!'] = 'Hello %s, your Hon Chai Art Gallery is empty!';
...
$lang['I want to add photos'] = 'I want to add paintings';
...
$lang['in %d sub-album'] = "in %d sub-gallery";
$lang['in %d sub-albums'] = "in %d sub-galleries";
$lang['in this album'] = "in this gallery";
...
$lang['Number of photos per page'] = "Number of paintings per page";
...
$lang['Permalink for album not found'] = 'Permalink for gallery not found';
$lang['Photo sizes'] = 'Painting image sizes';
$lang['Photo title, A &rarr; Z'] = 'Painting title, A &rarr; Z';
$lang['Photo title, Z &rarr; A'] = 'Painting title, Z &rarr; A';
$lang['photo'] = "painting";
$lang['Photos only RSS feed'] = "Paintings only RSS feed";
$lang['photos posted during the last %d days'] = "paintings posted during the last %d days";
$lang['Photos posted within the last %d day.'] = "Paintings posted within the last %d day only.";
$lang['Photos posted within the last %d days.'] = "Paintings posted within the last %d days only.";
$lang['Piwigo encountered a non recoverable error'] = 'HonChai.com encountered an unrecoverable error';
$lang['Piwigo Help'] = "HonChai.com help";
...
$lang['Random photos'] = "Random paintings";
$lang['Rank'] = "Rank";
$lang['Rate this photo'] = "Rate this painting";
...
$lang['Recent albums'] = "Recent galleries";
...
$lang['Recent photos'] = "Recent paintings";
...
$lang['Requested album does not exist'] = 'Requested gallery does not exist';
...
$lang['return to the display of all photos'] = "return to the display of all paintings";
...
$lang['Search in albums'] = "Search in galleries";
$lang['Search in sub-albums'] = "Search in sub-galleries";
...
$lang['set as album representative'] = "set as gallery thumbnail";
...
$lang['The number of photos per page must be a not null scalar'] = 'The number of paintings per page must be a non-zero integer';
$lang['The passwords do not match'] = 'The passwords do not match';
$lang['The RSS notification feed provides notification on news from this website : new photos, updated albums, new comments. Use a RSS feed reader.'] = "The RSS feed provides notification on new events from this website: new paintings, updated galleries, new comments. To be used with a RSS feed reader.";
...
$lang['Week %d'] = "Week %d";
$lang['Welcome to your Piwigo photo gallery!'] = 'Welcome to Hon Chai Art Gallery!';
$lang['Welcome'] = 'Welcome';
$lang['wrong date'] = "wrong date";
$lang['xlarge'] = 'XL - extra large';
$lang['xsmall'] = 'XS - extra small';
$lang['xxlarge'] = 'High Density';
$lang['Yes'] = "Yes";
...
$lang['%d photos per page'] = '%d paintings per page';
$lang['Theme'] = 'Theme';
$lang['No results for'] = 'No results for';
$lang['Apply on properties'] = 'Apply on properties';
$lang['Photo title'] = 'Painting title';
$lang['Photo description'] = 'Painting introduction';
$lang['Album name, A &rarr; Z'] = 'Gallery name, A &rarr; Z';
$lang['Album name, Z &rarr; A'] = 'Gallery name, Z &rarr; A';
$lang['Link: %s'] = 'Link: %s';
